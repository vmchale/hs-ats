...
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_utils_2esats__dirpath_append) (ats_ptr_type, ats_ptr_type, ats_char_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_global_2esats__the_ATSRELOC_get_decl) () ;
...
ATSextern_fun(ats_void_type, _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_atsreloc_insert) (ats_ptr_type, ats_ptr_type) ;
ATSextern_fun(ats_void_type, _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_atsreloc_insert2) (ats_ptr_type, ats_ptr_type, ats_ptr_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl0) (ats_ptr_type, ats_int_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl1) (ats_ptr_type, ats_int_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl0) (ats_ptr_type, ats_int_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl1) (ats_ptr_type, ats_int_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_eval) (ats_ptr_type) ;
...
/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 2562(line=116, offs=3) -- 2705(line=123, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl0 (ats_ptr_type arg0, ats_int_type arg1) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp0) ;
ATSlocal (ats_int_type, tmp1) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl0:
...
return (tmp0) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl0] */

/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 2869(line=133, offs=3) -- 2917(line=133, offs=51)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl1 (ats_ptr_type arg0, ats_int_type arg1) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp2) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl1:
...
/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 3049(line=143, offs=3) -- 4004(line=180, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl0 (ats_ptr_type arg0, ats_int_type arg1) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl0:
...
tmp12 = _2tmp_2ATS_2dPostiats_2src_2pats_symbol_2esats__symbol_make_string (ats_castfn_mac(ats_ptr_type, tmp10)) ;
tmp13 = _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_e1xpenv_find (tmp12) ;
do {
/* branch: __ats_lab_1 */
__ats_lab_1_0:
if (tmp13 != (ats_sum_ptr_type)0) { goto __ats_lab_2_0 ; }
__ats_lab_1_1:
tmp3 = _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl0 (arg0, arg1) ;
break ;
...
return (tmp3) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl0] */

/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 4167(line=190, offs=3) -- 5171(line=227, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl1 (ats_ptr_type arg0, ats_int_type arg1) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl1:
...
tmp25 = _2tmp_2ATS_2dPostiats_2src_2pats_symbol_2esats__symbol_make_string (ats_castfn_mac(ats_ptr_type, tmp23)) ;
tmp26 = _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_e1xpenv_find (tmp25) ;
do {
/* branch: __ats_lab_7 */
__ats_lab_7_0:
if (tmp26 != (ats_sum_ptr_type)0) { goto __ats_lab_8_0 ; }
__ats_lab_7_1:
tmp17 = _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get_gurl1 (arg0, arg1) ;
break ;
...
return (tmp17) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl1] */

/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 5357(line=242, offs=5) -- 5429(line=243, offs=46)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 5437(line=246, offs=1) -- 5609(line=260, offs=4)
*/
ATSstaticdec()
ats_int_type
...
/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 5640(line=263, offs=1) -- 5761(line=270, offs=2)
*/
ATSstaticdec()
ats_ptr_type
...
/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 5793(line=273, offs=1) -- 7340(line=341, offs=4)
*/
ATSstaticdec()
ats_ptr_type
...
tmp46 = _2tmp_2ATS_2dPostiats_2src_2pats_symbol_2esats__symbol_make_string (ats_castfn_mac(ats_ptr_type, tmp45)) ;
tmp47 = _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_e1xpenv_find (tmp46) ;
do {
/* branch: __ats_lab_13 */
__ats_lab_13_0:
...
/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 5314(line=238, offs=3) -- 7402(line=345, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_eval (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp30) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_eval:
tmp30 = auxeval0_8 (arg0, 0) ;
return (tmp30) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_eval] */

/*
// /tmp/ATS-Postiats/src/pats_filename_reloc.dats: 7536(line=355, offs=3) -- 9078(line=443, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_2esats__pkgsrcname_relocatize (ats_ptr_type arg0, ats_int_type arg1) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_filename_2esats__pkgsrcname_relocatize:
tmp55 = _2tmp_2ATS_2dPostiats_2src_2pats_global_2esats__the_ATSRELOC_get_decl () ;
tmp56 = atspre_lt_int_int (arg1, 0) ;
if (tmp56) {
tmp58 = atspre_pgt (tmp55, atspre_null_ptr) ;
if (tmp58) {
/* tmp57 = */ _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_atsreloc_insert (ats_castfn_mac(ats_ptr_type, tmp55), arg0) ;
} else {
/* empty */
} /* end of [if] */
tmp54 = arg0 ;
...
tmp61 = _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl1 (arg0, arg1) ;
tmp62 = _2tmp_2ATS_2dPostiats_2src_2pats_utils_2esats__dirpath_append (ats_castfn_mac(ats_ptr_type, tmp61), ats_castfn_mac(ats_ptr_type, tmp59), tmp60) ;
/* tmp63 = */ atspre_strptr_free (tmp61) ;
tmp64 = _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_eval (ats_castfn_mac(ats_ptr_type, tmp62)) ;
tmp66 = atspre_pgt (tmp55, atspre_null_ptr) ;
if (tmp66) {
tmp67 = _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_get2_gurl0 (arg0, arg1) ;
tmp68 = _2tmp_2ATS_2dPostiats_2src_2pats_utils_2esats__dirpath_append (ats_castfn_mac(ats_ptr_type, tmp67), ats_castfn_mac(ats_ptr_type, tmp59), tmp60) ;
/* tmp69 = */ atspre_strptr_free (tmp67) ;
tmp70 = _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__pkgsrcname_eval (ats_castfn_mac(ats_ptr_type, tmp68)) ;
/* tmp65 = */ _2tmp_2ATS_2dPostiats_2src_2pats_trans1_env_2esats__the_atsreloc_insert2 (ats_castfn_mac(ats_ptr_type, tmp55), tmp70, tmp64) ;
} else {
/* empty */
} /* end of [if] */
tmp54 = tmp64 ;
...
return (tmp54) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_filename_2esats__pkgsrcname_relocatize] */
...
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__staload () {
static int _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__staload_flag = 0 ;
if (_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__staload_flag) return ;
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__staload_flag = 1 ;
...
extern ats_int_type _2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__dynload_flag ;

ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__dynload () {
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__dynload_flag = 1 ;
_2tmp_2ATS_2dPostiats_2src_2pats_filename_reloc_2edats__staload () ;
