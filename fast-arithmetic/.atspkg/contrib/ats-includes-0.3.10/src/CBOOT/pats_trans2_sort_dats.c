...
ATSextern_val(ats_sum_type, _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__T2E_s1rt_tr_0) ;
...
ATSextern_fun(ats_bool_type, _2tmp_2ATS_2dPostiats_2src_2pats_staexp1_2esats__s1rt_is_arrow) (ats_ptr_type) ;
...
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_srt) (ats_ptr_type) ;
ATSextern_fun(anairiats_rec_1, _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_symsrt) (ats_ptr_type) ;
...
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_app) (ats_ptr_type, ats_ptr_type, ats_ptr_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_qid) (ats_ptr_type, ats_ptr_type, ats_ptr_type) ;
...
/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 1660(line=51, offs=28) -- 1694(line=51, offs=62)
*/
ATSstaticdec()
ats_void_type
...
/* tmp17 = */ _2tmp_2ATS_2dPostiats_2src_2pats_location_2esats__prerr_location (arg0) ;
...
/* tmp24 = */ _2tmp_2ATS_2dPostiats_2src_2pats_location_2esats__prerr_location (arg0) ;
/* tmp23 = */ atspre_prerr_string (ATSstrcst(": error(2)")) ;
return /* (tmp23) */ ;
} /* end of [prerr_error2_loc_02091_] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 2351(line=91, offs=13) -- 3308(line=125, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_app (ats_ptr_type arg0, ats_ptr_type arg1, ats_ptr_type arg2) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_app:
...
__ats_lab_0_0:
__ats_lab_0_1:
tmp4 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp1_2esats__s1rt_is_arrow (arg1) ;
...
tmp13 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtlst_tr (tmp9) ;
tmp14 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr (tmp8) ;
...
/* tmp1 = */ _2tmp_2ATS_2dPostiats_2src_2pats_error_2esats__abort_interr () ;
break ;
} while (0) ;
break ;
...
/* tmp26 = */ patsopt_prerrf_ifdebug (ATSstrcst(": [%s]: %s"), ATSstrcst("/tmp/ATS-Postiats/src/pats_trans2_sort.dats"), ATSstrcst("s1rt_tr_app")) ;
...
/* tmp29 = */ _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__the_trans2errlst_add (tmp30) ;
tmp1 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2rt_err () ;
break ;
} while (0) ;
return (tmp1) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_app] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 3379(line=131, offs=3) -- 4352(line=164, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_qid (ats_ptr_type arg0, ats_ptr_type arg1, ats_ptr_type arg2) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_qid:
tmp32 = ats_selbox_mac(ats_castptr_mac(anairiats_rec_2, arg0), atslab_s1rt_loc) ;
tmp33 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_env_2esats__the_s2rtenv_find_qua (arg1, arg2) ;
do {
/* branch: __ats_lab_6 */
__ats_lab_6_0:
...
/* tmp37 = */ patsopt_prerrf_ifdebug (ATSstrcst(": [%s]: %s"), ATSstrcst("/tmp/ATS-Postiats/src/pats_trans2_sort.dats"), ATSstrcst("s1rt_tr_qid")) ;
/* tmp38 = */ atspre_prerr_string (ATSstrcst(": the identifier [")) ;
/* tmp39 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symbol_2esats__prerr_symbol (arg2) ;
...
/* tmp42 = */ _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__the_trans2errlst_add (tmp43) ;
tmp31 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2rt_err () ;
break ;
} while (0) ;
break ;
...
/* tmp45 = */ patsopt_prerrf_ifdebug (ATSstrcst(": [%s]: %s"), ATSstrcst("/tmp/ATS-Postiats/src/pats_trans2_sort.dats"), ATSstrcst("s1rt_tr_qid")) ;
/* tmp46 = */ atspre_prerr_string (ATSstrcst(": the identifier [")) ;
/* tmp47 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symbol_2esats__prerr_symbol (arg2) ;
...
/* tmp50 = */ _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__the_trans2errlst_add (tmp51) ;
tmp31 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2rt_err () ;
break ;
} while (0) ;
return (tmp31) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_qid] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 4417(line=169, offs=9) -- 4825(line=188, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr (ats_ptr_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr:
...
tmp52 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_app (arg0, tmp55, tmp56) ;
break ;
...
tmp52 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2rt_impred (tmp57) ;
break ;
...
tmp52 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__s1rt_tr_qid (arg0, tmp58, tmp59) ;
break ;
...
tmp61 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtlst_tr (tmp60) ;
...
__ats_lab_14_1:
tmp52 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2rt_err () ;
break ;
} while (0) ;
return (tmp52) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr] */
...
/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 4890(line=194, offs=12) -- 4928(line=194, offs=50)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtlst_tr (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp62) ;
ATSlocal (ats_ptr_type, tmp63) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtlst_tr:
tmp63 = list_map_fun_01413_ats_ptr_type_ats_ptr_type (arg0, &_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr) ;
tmp62 = ats_castfn_mac(ats_ptr_type, tmp63) ;
return (tmp62) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtlst_tr] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 4952(line=197, offs=12) -- 5025(line=198, offs=52)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtopt_tr (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp75) ;
ATSlocal (ats_ptr_type, tmp76) ;
ATSlocal (ats_ptr_type, tmp77) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtopt_tr:
do {
/* branch: __ats_lab_17 */
__ats_lab_17_0:
...
tmp77 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr (tmp76) ;
...
return (tmp75) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rtopt_tr] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 5096(line=204, offs=14) -- 5122(line=204, offs=40)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_srt (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp78) ;
ATSlocal (ats_ptr_type, tmp79) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_srt:
tmp79 = ats_selbox_mac(ats_castptr_mac(anairiats_rec_8, arg0), atslab_a1srt_srt) ;
tmp78 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr (tmp79) ;
return (tmp78) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_srt] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 5148(line=206, offs=15) -- 5200(line=206, offs=67)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1msrt_tr_srt (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp80) ;
ATSlocal (ats_ptr_type, tmp81) ;
ATSlocal (ats_ptr_type, tmp82) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1msrt_tr_srt:
tmp82 = ats_selbox_mac(ats_castptr_mac(anairiats_rec_9, arg0), atslab_a1msrt_arg) ;
tmp81 = list_map_fun_01413_ats_ptr_type_ats_ptr_type (tmp82, &_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_srt) ;
tmp80 = ats_castfn_mac(ats_ptr_type, tmp81) ;
return (tmp80) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1msrt_tr_srt] */

/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 5250(line=211, offs=17) -- 5429(line=218, offs=4)
*/
ATSglobaldec()
anairiats_rec_1
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_symsrt (ats_ptr_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_symsrt:
...
__ats_lab_19_1:
tmp84 = _2tmp_2ATS_2dPostiats_2src_2pats_symbol_2esats__symbol_empty ;
break ;
...
tmp87 = _2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__s1rt_tr (tmp88) ;
tmp83.atslab_0 = tmp84 ;
tmp83.atslab_1 = tmp87 ;

return (tmp83) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_symsrt] */
...
/*
// /tmp/ATS-Postiats/src/pats_trans2_sort.dats: 5485(line=220, offs=18) -- 5540(line=220, offs=73)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1msrt_tr_symsrt (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp89) ;
ATSlocal (ats_ptr_type, tmp90) ;
ATSlocal (ats_ptr_type, tmp102) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1msrt_tr_symsrt:
tmp102 = ats_selbox_mac(ats_castptr_mac(anairiats_rec_9, arg0), atslab_a1msrt_arg) ;
tmp90 = list_map_fun_01413_ats_ptr_type_anairiats_rec_1 (tmp102, &_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1srt_tr_symsrt) ;
tmp89 = ats_castfn_mac(ats_ptr_type, tmp90) ;
return (tmp89) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans2_2esats__a1msrt_tr_symsrt] */
...
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__staload () {
static int _2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__staload_flag = 0 ;
if (_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__staload_flag) return ;
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__staload_flag = 1 ;
...
extern ats_int_type _2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__dynload_flag ;

ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__dynload () {
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__dynload_flag = 1 ;
_2tmp_2ATS_2dPostiats_2src_2pats_trans2_sort_2edats__staload () ;
