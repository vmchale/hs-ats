...
int _2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__sasp__lamlpenv_push_v = 0 ;
...
/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 1555(line=43, offs=28) -- 1589(line=43, offs=62)
*/
ATSstaticdec()
ats_void_type
...
/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 1919(line=68, offs=3) -- 2227(line=80, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_top:
...
return (tmp5) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_top] */

/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 2344(line=88, offs=5) -- 2810(line=108, offs=4)
*/
ATSstaticdec()
ats_ptr_type
...
/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 2320(line=86, offs=3) -- 2923(line=114, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp9 = loop_4 (tmp17) ;
return (tmp9) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_get_funarg] */

/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 3011(line=120, offs=3) -- 3180(line=125, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_pop () {
/* local vardec */
// ATSlocal_void (tmp18) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_pop:
tmp19 = ats_selsin_mac(ats_castfn_mac(ats_ptr_type, statmp1), atslab_1) ;
tmp20 = ats_ptrget_mac(ats_ptr_type, tmp19) ;
if (tmp20 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 3136(line=124, offs=7) -- 3163(line=124, offs=34)") ; }
tmp21 = ats_caselptrlab_mac(anairiats_sum_1, tmp20, atslab_1) ;
ATS_FREE(tmp20) ;
ats_ptrget_mac(ats_ptr_type, tmp19) = tmp21 ;
return /* (tmp18) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_pop] */

/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 3269(line=130, offs=23) -- 3440(line=136, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_lam (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp22) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_lam:
...
return /* (tmp22) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_lam] */

/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 3531(line=141, offs=25) -- 3696(line=147, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_loop0 () {
/* local vardec */
// ATSlocal_void (tmp27) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_loop0:
tmp28 = ats_selsin_mac(ats_castfn_mac(ats_ptr_type, statmp1), atslab_1) ;
tmp30 = (ats_sum_ptr_type)(&_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__LAMLPloop0_1) ;
...
return /* (tmp27) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_loop0] */

/*
// /tmp/ATS-Postiats/src/pats_trans3_env_lamlp.dats: 3770(line=151, offs=3) -- 3967(line=157, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_loop1 (ats_ptr_type arg0, ats_ptr_type arg1, ats_ptr_type arg2) {
/* local vardec */
// ATSlocal_void (tmp32) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_loop1:
...
return /* (tmp32) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_2esats__the_lamlpenv_push_loop1] */
...
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__staload () {
static int _2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__staload_flag = 0 ;
if (_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__staload_flag) return ;
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__staload_flag = 1 ;
...
extern ats_int_type _2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__dynload_flag ;

ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__dynload () {
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__dynload_flag = 1 ;
_2tmp_2ATS_2dPostiats_2src_2pats_trans3_env_lamlp_2edats__staload () ;
