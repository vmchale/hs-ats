...
ATSextern_fun(ats_void_type, _2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_lexerr) (ats_ptr_type, ats_ptr_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__the_lexerrlst_get) (ats_ref_type) ;
...
/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 1667(line=54, offs=3) -- 1722(line=56, offs=2)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__lexerr_make (ats_ptr_type arg0, ats_ptr_type arg1) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp0) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__lexerr_make:
...
return (tmp0) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__lexerr_make] */
...
/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 2279(line=87, offs=3) -- 2488(line=94, offs=2)
*/
ATSglobaldec()
ats_void_type
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__the_lexerrlst_clear:
...
return /* (tmp8) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__the_lexerrlst_clear] */

/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 2552(line=98, offs=3) -- 2858(line=109, offs=2)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__the_lexerrlst_add (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp16) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__the_lexerrlst_add:
...
return /* (tmp16) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__the_lexerrlst_add] */
...
/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 2920(line=113, offs=3) -- 3127(line=120, offs=2)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__the_lexerrlst_get (ats_ref_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__the_lexerrlst_get:
...
tmp24 = tmp28 ;
return (tmp24) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__the_lexerrlst_get] */

/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 3229(line=128, offs=3) -- 5917(line=203, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_lexerr (ats_ptr_type arg0, ats_ptr_type arg1) {
/* local vardec */
// ATSlocal_void (tmp37) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_lexerr:
tmp38 = ats_selbox_mac(ats_castptr_mac(anairiats_rec_1, arg1), atslab_lexerr_loc) ;
/* tmp39 = */ _2tmp_2ATS_2dPostiats_2src_2pats_location_2esats__fprint_location (arg0, tmp38) ;
...
return /* (tmp37) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_lexerr] */

/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 6067(line=213, offs=7) -- 6304(line=220, offs=27)
*/
ATSstaticdec()
ats_int_type
...
ATS_FREE(arg1) ;
/* tmp73 = */ _2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_lexerr (arg0, tmp71) ;
...
/*
// /tmp/ATS-Postiats/src/pats_lexing_error.dats: 5999(line=209, offs=3) -- 6719(line=239, offs=4)
*/
ATSglobaldec()
ats_int_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_the_lexerrlst (ats_ptr_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_the_lexerrlst:
/* ats_int_type tmp68 ; */
tmp69 = _2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__the_lexerrlst_get ((&tmp68)) ;
do {
/* branch: __ats_lab_18 */
__ats_lab_18_0:
...
return (tmp67) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_lexing_2esats__fprint_the_lexerrlst] */
...
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__staload () {
static int _2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__staload_flag = 0 ;
if (_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__staload_flag) return ;
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__staload_flag = 1 ;
...
extern ats_int_type _2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__dynload_flag ;

ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__dynload () {
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__dynload_flag = 1 ;
_2tmp_2ATS_2dPostiats_2src_2pats_lexing_error_2edats__staload () ;
