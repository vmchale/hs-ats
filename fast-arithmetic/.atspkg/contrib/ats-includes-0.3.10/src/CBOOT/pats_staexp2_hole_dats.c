...
ATSextern_fun(ats_int_type, _2tmp_2ATS_2dPostiats_2src_2pats_stamp_2esats__s2hole_stamp_make) () ;
ATSextern_fun(ats_int_type, _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_stamp) (ats_ptr_type) ;
...
int _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__sasp__s2hole_type = 0 ;
...
/*
// /tmp/ATS-Postiats/src/pats_staexp2_hole.dats: 1863(line=67, offs=17) -- 2130(line=77, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_make_srt (ats_ptr_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_make_srt:
...
return (tmp0) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_make_srt] */

/*
// /tmp/ATS-Postiats/src/pats_staexp2_hole.dats: 2185(line=80, offs=16) -- 2275(line=82, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_srt (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp5) ;
ATSlocal (ats_ptr_type, tmp6) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_srt:
...
return (tmp5) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_srt] */

/*
// /tmp/ATS-Postiats/src/pats_staexp2_hole.dats: 2331(line=85, offs=18) -- 2423(line=87, offs=4)
*/
ATSglobaldec()
ats_int_type
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_stamp (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_int_type, tmp7) ;
ATSlocal (ats_ptr_type, tmp8) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_stamp:
...
return (tmp7) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_stamp] */

/*
// /tmp/ATS-Postiats/src/pats_staexp2_hole.dats: 2524(line=95, offs=3) -- 2640(line=101, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__fprint_s2hole (ats_ptr_type arg0, ats_ptr_type arg1) {
/* local vardec */
// ATSlocal_void (tmp9) ;
ATSlocal (ats_int_type, tmp10) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__fprint_s2hole:
tmp10 = _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__s2hole_get_stamp (arg1) ;
/* tmp9 = */ _2tmp_2ATS_2dPostiats_2src_2pats_stamp_2esats__fprint_stamp (arg0, tmp10) ;
return /* (tmp9) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_2esats__fprint_s2hole] */
...
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__staload () {
static int _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__staload_flag = 0 ;
if (_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__staload_flag) return ;
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__staload_flag = 1 ;
...
extern ats_int_type _2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__dynload_flag ;

ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__dynload () {
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__dynload_flag = 1 ;
_2tmp_2ATS_2dPostiats_2src_2pats_staexp2_hole_2edats__staload () ;
