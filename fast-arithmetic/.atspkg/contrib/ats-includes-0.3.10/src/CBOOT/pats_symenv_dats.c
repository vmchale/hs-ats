...
ATSextern_fun(ats_void_type, _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_joinwth) (ats_ref_type, ats_ptr_type) ;
ATSextern_fun(ats_void_type, _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__fprint_symmap) (ats_ptr_type, ats_ptr_type, ats_ptr_type) ;
ATSextern_fun(ats_ptr_type, _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop) (ats_ref_type) ;
ATSextern_fun(ats_void_type, _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push) (ats_ref_type, ats_ptr_type) ;
...
int _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__sasp__symenv_vt0ype = 0 ;
...
/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 1690(line=56, offs=1) -- 1878(line=62, offs=26)
*/
ATSstaticdec()
ats_void_type
...
ATS_FREE(arg0) ;
/* tmp3 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_free (tmp1) ;
arg0 = tmp2 ;
...
/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 1911(line=66, offs=1) -- 2491(line=84, offs=4)
*/
ATSstaticdec()
ats_ptr_type
...
tmp7 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_search (tmp8, arg1) ;
do {
/* branch: __ats_lab_3 */
__ats_lab_3_0:
...
/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 2787(line=101, offs=9) -- 3081(line=111, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_make_nil:
tmp12 = ptr_alloc_01070_anairiats_rec_2 () ;
tmp14 = ats_selsin_mac(tmp12, atslab_2) ;
tmp15 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_make_nil () ;
...
tmp18 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_make_nil () ;
ats_selptr_mac(ats_castptr_mac(anairiats_rec_2, tmp14), atslab_pervasive) = tmp18 ;
tmp11 = tmp14 ;
return (tmp11) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_make_nil] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 3164(line=117, offs=9) -- 3327(line=123, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_search (ats_ref_type arg0, ats_ptr_type arg1) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_search:
tmp21 = ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_map) ;
tmp20 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_search (tmp21, arg1) ;
do {
/* branch: __ats_lab_6 */
__ats_lab_6_0:
...
return (tmp19) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_search] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 3408(line=129, offs=3) -- 3457(line=129, offs=52)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_insert (ats_ref_type arg0, ats_ptr_type arg1, ats_ptr_type arg2) {
/* local vardec */
// ATSlocal_void (tmp23) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_insert:
/* tmp23 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_insert (&ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_map), arg1, arg2) ;
return /* (tmp23) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_insert] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 3529(line=136, offs=3) -- 3673(line=141, offs=2)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop (ats_ref_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop:
...
if (tmp26 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/tmp/ATS-Postiats/src/pats_symenv.dats: 3577(line=138, offs=7) -- 3615(line=138, offs=45)") ; }
...
tmp24 = tmp25 ;
return (tmp24) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 3726(line=145, offs=3) -- 3804(line=148, offs=2)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop_free (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp29) ;
ATSlocal (ats_ptr_type, tmp30) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop_free:
tmp30 = _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop (arg0) ;
/* tmp29 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_free (tmp30) ;
return /* (tmp29) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pop_free] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 3858(line=152, offs=3) -- 3971(line=155, offs=2)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push (ats_ref_type arg0, ats_ptr_type arg1) {
/* local vardec */
// ATSlocal_void (tmp31) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push:
...
return /* (tmp31) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 4025(line=159, offs=3) -- 4110(line=162, offs=2)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push_nil (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp35) ;
ATSlocal (ats_ptr_type, tmp36) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push_nil:
tmp36 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_make_nil () ;
/* tmp35 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push (arg0, tmp36) ;
return /* (tmp35) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_push_nil] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 4190(line=168, offs=3) -- 4286(line=173, offs=2)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_top_clear (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp37) ;
// ATSlocal_void (tmp38) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_top_clear:
tmp39 = ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_map) ;
/* tmp38 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_free (tmp39) ;
tmp40 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_make_nil () ;
ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_map) = tmp40 ;
return /* (tmp37) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_top_clear] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 4373(line=179, offs=8) -- 4589(line=187, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_savecur (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp41) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_savecur:
...
return /* (tmp41) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_savecur] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 4650(line=191, offs=8) -- 4889(line=200, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_restore (ats_ref_type arg0) {
/* local vardec */
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_restore:
...
if (tmp53 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/tmp/ATS-Postiats/src/pats_symenv.dats: 4757(line=195, offs=7) -- 4793(line=195, offs=43)") ; }
...
tmp49 = tmp50 ;
return (tmp49) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_restore] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 4973(line=206, offs=8) -- 5408(line=226, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_localjoin (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp58) ;
...
__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_localjoin:
tmp59 = ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_maplst) ;
if (tmp59 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/tmp/ATS-Postiats/src/pats_symenv.dats: 5012(line=209, offs=5) -- 5039(line=209, offs=32)") ; }
tmp60 = ats_caselptrlab_mac(anairiats_sum_1, tmp59, atslab_0) ;
tmp61 = ats_caselptrlab_mac(anairiats_sum_1, tmp59, atslab_1) ;
ATS_FREE(tmp59) ;
/* tmp62 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_free (tmp60) ;
if (tmp61 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/tmp/ATS-Postiats/src/pats_symenv.dats: 5070(line=211, offs=5) -- 5097(line=211, offs=32)") ; }
...
/* tmp66 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_joinwth (&ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_map), tmp65) ;
/* tmp67 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_free (tmp65) ;
/* tmp58 = tmp66 */ ;
return /* (tmp58) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_localjoin] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 5496(line=232, offs=3) -- 5541(line=233, offs=35)
*/
ATSglobaldec()
ats_ptr_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_search (ats_ref_type arg0, ats_ptr_type arg1) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp68) ;
ATSlocal (ats_ptr_type, tmp69) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_search:
tmp69 = ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_pervasive) ;
tmp68 = _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_search (tmp69, arg1) ;
return (tmp68) ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_search] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 5615(line=238, offs=3) -- 5666(line=239, offs=38)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_insert (ats_ref_type arg0, ats_ptr_type arg1, ats_ptr_type arg2) {
/* local vardec */
// ATSlocal_void (tmp70) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_insert:
/* tmp70 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_insert (&ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_pervasive), arg1, arg2) ;
return /* (tmp70) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_insert] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 5753(line=246, offs=3) -- 5847(line=252, offs=4)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_joinwth0 (ats_ref_type arg0, ats_ptr_type arg1) {
/* local vardec */
// ATSlocal_void (tmp71) ;
// ATSlocal_void (tmp72) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_joinwth0:
/* tmp72 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_joinwth (&ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_pervasive), arg1) ;
/* tmp71 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_free (arg1) ;
return /* (tmp71) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_joinwth0] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 5925(line=256, offs=3) -- 5973(line=256, offs=51)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_joinwth1 (ats_ref_type arg0, ats_ptr_type arg1) {
/* local vardec */
// ATSlocal_void (tmp73) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_joinwth1:
/* tmp73 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__symmap_joinwth (&ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg0), atslab_pervasive), arg1) ;
return /* (tmp73) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__symenv_pervasive_joinwth1] */

/*
// /tmp/ATS-Postiats/src/pats_symenv.dats: 6064(line=263, offs=3) -- 6111(line=263, offs=50)
*/
ATSglobaldec()
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__fprint_symenv_map (ats_ptr_type arg0, ats_ref_type arg1, ats_ptr_type arg2) {
/* local vardec */
// ATSlocal_void (tmp74) ;
ATSlocal (ats_ptr_type, tmp75) ;

__ats_lab__2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__fprint_symenv_map:
tmp75 = ats_select_mac(ats_ptrget_mac(anairiats_rec_2, arg1), atslab_map) ;
/* tmp74 = */ _2tmp_2ATS_2dPostiats_2src_2pats_symmap_2esats__fprint_symmap (arg0, tmp75, arg2) ;
return /* (tmp74) */ ;
} /* end of [_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2esats__fprint_symenv_map] */
...
ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__staload () {
static int _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__staload_flag = 0 ;
if (_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__staload_flag) return ;
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__staload_flag = 1 ;
...
extern ats_int_type _2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__dynload_flag ;

ats_void_type
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__dynload () {
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__dynload_flag = 1 ;
_2tmp_2ATS_2dPostiats_2src_2pats_symenv_2edats__staload () ;
